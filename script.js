...
/* ================================================================
   ...
   ================================================================ */
const PRODUCTS = {
  'baklava-pesteh':    { name: 'باقلوای پسته',        price: 185000 },
  'sohan-ghom':        { name: 'سوهان زعفرانی قم',    price: 140000 },
  'ghotab-yazdi':      { name: 'قطاب یزدی',            price: 160000 },
  'gaz-esfahan':       { name: 'گز اصفهان',            price: 120000 },
  'zoolbia-bamie':     { name: 'زولبیا و بامیه',       price: 95000  },
  'koloocheh-fouman':  { name: 'کلوچه فومنی',          price: 110000 },
};
...
/** یک کالا را به سبد اضافه می‌کند؛ اگر قبلاً در سبد بود، فقط تعدادش زیاد می‌شود */
...
/** تعداد یک کالا را کم/زیاد می‌کند؛ اگر تعداد به صفر برسد، کالا حذف می‌شود */
...
/** یک کالا را کامل از سبد حذف می‌کند */
...
/** تعداد کل قلم‌های داخل سبد را محاسبه می‌کند (برای نشان روی آیکون سبد) */
...
function renderCart(){
  ...
  // ۲. ساخت لیست کالاها در پنل سبد خرید
...
/* اتصال دکمه‌ی «افزودن به سبد» تمام کارت‌های محصول (با Event Delegation روی کل صفحه) */
